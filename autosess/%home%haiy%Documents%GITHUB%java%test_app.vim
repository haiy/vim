...
silent only
cd ~/Documents/GITHUB/java/test_app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/main/java/com/mycompany/app/MyTest.java
args src/main/java/com/mycompany/app/MyTest.java
edit src/main/java/com/mycompany/app/MyTest.java
...
exe '1resize ' . ((&lines * 3 + 26) / 52)
exe '2resize ' . ((&lines * 44 + 26) / 52)
argglobal
enew
let s:cpo_save=&cpo
set cpo&vim
...
54
normal! zo
let s:l = 55 - ((19 * winheight(0) + 22) / 44)
