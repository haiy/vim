...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/autosess,~/.vim/bundle/jedi-vim,~/.vim/bundle/vim-peepopen,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/eclim,~/.vim/eclim/after
set scrolloff=7
set shiftwidth=4
set showcmd
set showmatch
...
silent only
cd ~/Documents/test_project/ade/IDCenter/IDMap/src/main/java/com/duozhun/zerone
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 SimpleMap.java
args SimpleMap.java
edit SimpleMap.java
...
147
normal! zo
let s:l = 41 - ((19 * winheight(0) + 22) / 45)
